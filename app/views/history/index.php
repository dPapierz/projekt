...
<?php include_once APP_PATH . DS . 'views' . DS . 'menu.php' ?>
    ...
    <main class="container grid grid-justify-center">
        ...
        <div class="grid grid-col-12 grid-justify-center width-100"> 
            ...
            <p class="grid-col-1 grid-item-justify-center"><a class="link1" href="<?php echo ROOT_URL ?>/history/archive/3">[3]</a></p>

            <p class="grid-col-1 grid-item-justify-center"><a class="link1" href="<?php echo ROOT_URL ?>/history/archive/7">[7]</a></p>

            <p class="grid-col-1 grid-item-justify-center"><a class="link1" href="<?php echo ROOT_URL ?>/history/archive/15">[15]</a></p>

            <p class="grid-col-1 grid-item-justify-center"><a class="link1" href="<?php echo ROOT_URL ?>/history/archive/30">[30]</a></p>
